...
public class PixyCamSubsystem {
    ...
    public int getCorrectPixyX() {
        ...
        try {
            if ((DriverStation.getAlliance() == Alliance.Red) && (blocks.get(0).getSignature()==2)) {
                return (blocks.get(0).getX());
            } else if ((DriverStation.getAlliance() == Alliance.Blue) && (blocks.get(0).getSignature() == 1)) {
                return (blocks.get(0).getX());
            } else {
                return (-1);
            }
