...
public class ShootSubsystem extends SubsystemBase{
    ...
    public ShootSubsystem() {
        kP = 0.0004;//.0003          // .000262//0.00024; //.00022 //0.0420 ultimate gain //.1395 //.01 //.003 //.0012
        kI = 0; //.00000001 .000000000001
        kD = .5;//1.5 //.08               //.00041// 0.0003; //.0005// 0.0002 //.00002
        kF = .000175; //0.000175
        shooterPID.setP(kP);
        shooterPID.setI(kI);
        shooterPID.setD(kD);
        ...
        //shooterFollowerPID.setIZone();

        Motors.shooterLeader.setClosedLoopRampRate(0.98);
        Motors.shooterFollower.setClosedLoopRampRate(0.98);
